        ...
        <div id="about">
            ...
            <div id="about_container">
                ...
                <div id="about_text_container">
                    <h4 className="about_text">Hello, my name is Edmond Woulfe, but you can call me Ed.</h4>
                    <h4 className="about_text"> I attended the University of Wisconsin - Parkside where I persued a degree in Computer Science.</h4>
